...
public class salereport extends javax.swing.JInternalFrame {
 ...
 try
 {
 String q="select saleid,name,gtotal,date from buyer where date between ? and ?";
 ...
 do
 {
 String saleid=myres.getString("saleid");
 String name=myres.getString("name");
 String cost=myres.getString("gtotal");
 String billdt=myres.getString("date");
 Object myrow[] = {saleid,name,cost,billdt};
 mymodel.addRow(myrow);
 gtotal1+=myres.getDouble("gtotal");
 }
 while(myres.next());
 jLabel5.setText(String.valueOf(gtotal1));
 }
 else
 {
 ...
 saledet obj = new saledet();
 obj.saleid=jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();//HERE PURCHID GOT ITS VALUE FROM THE TABLE
 ...
 {
 MessageFormat headerFormat = new MessageFormat("Sale Report");//HEADER= TOP OF PRINTED PAGE
